<template>
          ...
          <div class="card-body text-center">
            <div class="d-flex justify-content-center align-items-center">
              <div class="me-3">
                ...
                <small>Автор</small>
                <p><a class="text-decoration-none text-black" href="#">{{username}}</a></p>
              </div>
    ...
    mounted() {
      axios.get('http://localhost:8080/api/menu/'+this.$route.params.id)
        .then(response => {
          ...
          this.imageSrc = `http://localhost:8080/api/${this.menu.menuId}`
  ...
  <style scoped>
  .divider {
    border-left: 2px solid #ccc; /* Лінія перегородки */
    height: 50px; /* Висота лінії */
    margin: 0 20px; /* Відступи від лівого та правого боку лінії */
  }
  </style>
